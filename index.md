...
王昕元，哈尔滨工业大学（深圳）计算机科学与技术专业博士，现任梧州学院人工智能学院专任教师。


## 研究方向

本人博士期间的研究领域为并行事务系统。事务可以看作是多个需要访问和修改共享数据的程序，而我的研究目标是在保证多个事务并发执行结果与串行执行结果一致的前提下，通过并发控制方法使系统吞吐量最大化。

目前，我的研究方向为基于大模型的SQL生成，主要通过剪枝和并行的方法来加速推理（Reasoning）过程。
...
- Wanqiang Zeng, **Xinyuan Wang** & Hejiao Huang MVDR: Enabling Transaction Dependency Repair in Interactive Transaction Processing [C] . Algorithms and Architectures for Parallel Processing, 2026
[[Paper](https://orcid.org/0000-0001-6359-7869)]
